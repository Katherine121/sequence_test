...
def vit_small_patch16_224_FSRA(img_size=(256, 128), stride_size=16, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
                               local_feature=False, **kwargs):
...
class fsra_three_view_net(nn.Module):
    def __init__(self, class_num, share_weight=False, block=4, return_f=False):
        super(fsra_three_view_net, self).__init__()
